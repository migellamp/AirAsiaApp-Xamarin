...
[assembly: 
    ExportFont("Poppins-Black.ttf", Alias = "Poppins-Black"),
    ExportFont("Poppins-Bold.ttf", Alias = "Poppins-Bold"),
    ExportFont("Poppins-Regular.ttf", Alias = "Poppins")
    ]
namespace FirstApp

{
    ...
    public partial class MainPage : ContentPage
    {
        ...
        {
            string name = "Tiket Jakarta ke Surabaya berhasil Dipesan";
            lblName.Text = name;
